...
// Kelas HomePage untuk menampilkan daftar buku perpustakaan
...
class _HomePageState extends State<HomePage> {
  // Variabel untuk menyimpan daftar buku dan status loading
  List<dynamic> books = [];
  bool isLoading = true;
  ...
  void initState() {
    super.initState();
    // Memanggil fungsi fetchBooks saat halaman pertama kali dibuka
    fetchBooks();
  }
